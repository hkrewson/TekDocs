...
4. **Operational records** — Organizations, vendors, people, sites, products, licenses, stock, domains, certificates, credential references. Status: in progress; People and Sites now use the complete record workspace, with Organizations next before grouped responsive and live-stack acceptance.
