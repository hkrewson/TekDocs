...
.PHONY: bootstrap build up down logs check test test-auth-abuse test-isolation test-organizations test-workspaces test-people test-sites test-custom-fields test-compose test-e2e test-e2e-all test-e2e-live security release-gate schema migrations mail-test compose-doctor production-image-rehearsal clean-install-rehearsal upgrade-rehearsal
...
release-gate: check test test-auth-abuse test-compose test-isolation test-organizations test-workspaces test-people test-sites test-custom-fields test-e2e-all test-e2e-live security production-image-rehearsal clean-install-rehearsal upgrade-rehearsal
