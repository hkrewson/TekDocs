...
5. **Documentation and files** — Libraries, reader/editor, templates, blocks, maps, reviews, publications, exports and files. Status: in progress; document library/reader, template/reusable-content, ownership/review, retained publication sections and focused editable exports implemented; broader acceptance remains open.
