...
The template and reusable-content checkpoint is recorded in [template-and-block-workflows.md](template-and-block-workflows.md). The ownership/review checkpoint is recorded in [ownership-and-review.md](ownership-and-review.md). The publication safety checkpoint is recorded in [publication-safety.md](publication-safety.md). The retained viewer/editable export checkpoint is recorded in [publication-and-exports.md](publication-and-exports.md). The focused managed-file/PDF checkpoint is recorded in [managed-files-and-pdf.md](managed-files-and-pdf.md). The document-wide draft checkpoint is recorded in [document-draft-protection.md](document-draft-protection.md). The content-health/link-picker checkpoint is recorded in [document-health-and-links.md](document-health-and-links.md). Direct-link and retained-history acceptance is recorded in [document-direct-links-and-history.md](document-direct-links-and-history.md). Automated responsive and real-stack coverage is complete for the implemented Phase 5 workflow; technician acceptance remains required before Phase 5 is accepted.
