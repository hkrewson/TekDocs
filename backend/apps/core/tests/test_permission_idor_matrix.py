...
def _kwargs_for(route_name: str) -> dict[str, object]:
    ...
    route_kwargs: dict[str, tuple[str, ...]] = {
        ...
        "organization-recurring-invoice-detail": ("organization_entity_id", "schedule_id",),
        "organization-recurring-invoice-due": ("organization_entity_id", "schedule_id",),
        "organization-recurring-invoice-preview": ("organization_entity_id", "schedule_id",),
        "organization-recurring-invoice-apply": ("organization_entity_id", "schedule_id",),
