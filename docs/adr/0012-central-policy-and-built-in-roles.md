...
- This release deliberately does not add custom roles, organization/collection assignments, explicit deny rules, or client-portal identities. Those remain `0.1.10`.
