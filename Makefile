...
test-invoice-recurrence:
	docker compose run --rm migrate pytest apps/core/tests/test_invoice_recurrence.py apps/core/tests/test_recurring_invoices.py apps/core/tests/test_money.py -q
