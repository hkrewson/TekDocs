...
function inventoryClient(overrides: Partial<InventoryClient> = {}): InventoryClient {
  return {
    ...
    loadDocument: vi.fn(), listVendors: vi.fn(), retrieveVendor: vi.fn(), artifactUrl: vi.fn(), assetCsvTemplateUrl: vi.fn(), assetCsvExportUrl: vi.fn(), previewAssetCsv: vi.fn(), applyAssetCsv: vi.fn(),
    ...overrides,
  }
}
