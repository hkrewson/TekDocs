...
- Simplified network records for locations, VLANs, CIDRs, ranges, gateways, DNS, and asset MAC addresses; parent network drawers include searchable, paginated IP addresses and wireless SSIDs with focused editing; VLAN/VRF registers include associated subnet browsing
