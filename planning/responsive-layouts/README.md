...
6. **Financial and integration workflows** — Invoices, recurring workflows, compliance/data flows, integrations/imports/webhooks and exceptions. Status: in progress; client invoice collection, focused record workspace and MSP invoice settings workspace complete.
...
- [Invoice collection and focused record workspace](invoice-workspace.md)
...
- [Managed files and PDF viewing](managed-files-and-pdf.md)
- [Document-wide draft protection](document-draft-protection.md)
- [Document health queue and link picker](document-health-and-links.md)
