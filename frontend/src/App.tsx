...
function Overview() {
  return (
    <>
      <PageHeader title="Overview" description="TekDocs 0.4.6" />
      <section className="content-section">
        <div className="section-heading"><h2>Foundation status</h2><span>0.4.6</span></div>
...
const organizationAreaDetails: Partial<Record<WorkspaceCapability, { title: string; description: string; release: string }>> = {
  ...
  networks: { title: 'Networks', description: 'Network inventory, provider circuits, handoffs, and lifecycle dates.', release: '0.4.6' },
