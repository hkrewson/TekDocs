  ...
  return (
    <section className="content-section staff-administration" aria-labelledby="staff-administration-heading">
      <div className="section-heading settings-heading">
        ...
        <button className="secondary-button refresh-button" type="button" disabled={working} onClick={() => { setError(null); void reload().catch((loadError: unknown) => setError(message(loadError))) }}><RefreshCw size={15} />Refresh</button>
      </div>
