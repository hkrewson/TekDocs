...
- Software History now presents bounded, record-specific audit events with the existing Activity permission; see [software-history.md](software-history.md). Historical installation-field values are not available and are not inferred.
