...
.PHONY: bootstrap build up down logs check test test-auth-abuse test-isolation test-organizations test-compose test-e2e test-e2e-all security release-gate schema migrations mail-test clean-install-rehearsal upgrade-rehearsal
...
release-gate: check test test-auth-abuse test-compose test-isolation test-organizations test-e2e-all security clean-install-rehearsal upgrade-rehearsal
