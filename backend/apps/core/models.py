...
# Kept because historical migration 0133 imports this callable while rebuilding a database.
def documentation_map_baseline_upload_to(instance: Any, _filename: str) -> str:
    return str(
        PurePosixPath("documentation-map-baselines")
        / str(instance.tenant_id)
        / str(instance.id)
        / "bundle.zip"
    )
