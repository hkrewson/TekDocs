...
| Unified client workspace search | 10 | 163.4 ms (`#27` evidence; 5 observed service queries) |
| Client relationship discovery | 6 | 10.9 ms |
| Document revision-history page | 3 | 20.6 ms (`0.2.9` evidence) |
| Client asset page (25 of 120) | 32 whole-request queries | `< 500 ms` (`0.4.0` validation) |
| Client software-license page (25 of 60) | 32 whole-request queries | `< 500 ms` (`0.4.0` validation) |
| Client contract page (25 of 120) | 32 whole-request queries | `< 500 ms` (`0.4.0` validation) |
| Client credential-reference page (25 of 120) | 32 whole-request queries | `< 500 ms` (`0.4.0` validation) |
...
make test-documentation-validation
make test-inventory-validation
make test-portal-notification-validation
```
