...
export function Sites({ workspace, client = browserSitesClient }: { workspace: WorkspaceContext | null; client?: SitesClient }) {
  ...
  const refresh = (notice: string) => { setEditingSite(null); setEditingLocation(null); setArchiving(null); setMessage(notice); setRevision((value) => value + 1) }
