...
run_case 0.1.3 147d00c env TEKDOCS_UPGRADE_FROM_REF=147d00c \
  "$repository_root/tests/rehearsals/rehearse-upgrade.sh"
...
run_case 0.5.9 f15b6a7 env TEKDOCS_PORTAL_NOTIFICATION_UPGRADE_FROM_REF=f15b6a7 \
  ...
  "$repository_root/tests/rehearsals/rehearse-portal-notification-upgrade.sh"
run_case 0.6.9 fc8aec7 env TEKDOCS_INTEGRATION_UPGRADE_FROM_REF=fc8aec7 \
  ...
  "$repository_root/tests/rehearsals/rehearse-integration-upgrade.sh"
run_case 0.7.13 8fdde2d env TEKDOCS_VALIDATION_UPGRADE_FROM_REF=8fdde2d \
  TEKDOCS_VALIDATION_UPGRADE_FROM_VERSION=0.7.13 \
  "$repository_root/tests/rehearsals/rehearse-compliance-monitoring-upgrade.sh"
