...
6. **Financial and integration workflows** — Invoices, recurring workflows, compliance/data flows, integrations/imports/webhooks and exceptions. Status: in progress; client invoice collection and focused record workspace complete.
