...
5. **Documentation and files** — Libraries, reader/editor, templates, blocks, maps, reviews, publications, exports and files. Status: in progress; document library/reader, template/reusable-content, ownership/review, retained publication sections, focused editable exports, managed-file/PDF controls and document-wide draft protection implemented; broader acceptance remains open.
