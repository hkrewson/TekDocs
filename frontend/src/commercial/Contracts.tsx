...
export function Contracts({ workspace, client }: { workspace: WorkspaceContext; client: CommercialClient }) {
  ...
  return <>
    ...
    {phase === 'error' && <section className="content-section workspace-error" role="alert"><h2>Contracts unavailable</h2><p>The client commercial records could not be loaded.</p></section>}
