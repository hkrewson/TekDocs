...
describe('operations API client', () => {
  ...
  it('uses exact workspace routes for reminders, calendar export, and activity', async () => {
    ...
    expect(fetchMock.mock.calls[3]?.[0]).toBe('/api/v1/workspaces/organizations/client%2Fid/activity?page=1&page_size=25&entity_id=asset%2Fid&handoff_id=handoff%2Fid')
