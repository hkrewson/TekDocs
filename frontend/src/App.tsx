...
const plannedAreas: Record<string, { title: string; description: string; release: string; capabilities: string[] }> = {
  ...
  '/networks': { title: 'Networks', description: 'Racks, hardware, VLANs, addresses, DNS, and NetBox identities.', release: '0.5.0', capabilities: ['Lightweight address management', 'Physical placement', 'NetBox-compatible identifiers'] },
...
function Overview() {
  return (
    <>
      <PageHeader title="Overview" description="TekDocs 0.4.8" />
      <section className="content-section">
        <div className="section-heading"><h2>Foundation status</h2><span>0.4.8</span></div>
...
const organizationAreaDetails: Partial<Record<WorkspaceCapability, { title: string; description: string; release: string }>> = {
  ...
  networks: { title: 'Networks', description: 'Lightweight network inventory with exact-workspace search and export.', release: '0.4.8' },
