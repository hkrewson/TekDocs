...
urlpatterns = [
    ...
    path(
        "api/v1/workspaces/msp/integrations/jobs/<uuid:job_id>/cancel",
        IntegrationJobCancelView.as_view(),
    ...
    path(
        ...
        AssetCollectionView.as_view(),
        {"organization_entity_id": None},
        name="msp-asset-collection",
    ),
    path(
    ...
    path(
        "api/v1/workspaces/organizations/<uuid:organization_entity_id>/assets/collection",
        AssetCollectionView.as_view(),
        name="organization-asset-collection",
    ),
    path(
    ...
    path(
        "api/v1/workspaces/organizations/<uuid:organization_entity_id>/integrations/jobs/<uuid:job_id>/cancel",
        IntegrationJobCancelView.as_view(),
        name="organization-integration-job-cancel",
    ),
    path(
