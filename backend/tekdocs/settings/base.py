...
TEKDOCS_DIAGRAM_JOB_DIRECTORY = os.getenv("TEKDOCS_DIAGRAM_JOB_DIRECTORY", "")
TEKDOCS_DIAGRAM_RENDER_TIMEOUT_SECONDS = env_int("TEKDOCS_DIAGRAM_RENDER_TIMEOUT_SECONDS", 20)
if not 5 <= TEKDOCS_DIAGRAM_RENDER_TIMEOUT_SECONDS <= 60:
    raise ImproperlyConfigured("TEKDOCS_DIAGRAM_RENDER_TIMEOUT_SECONDS must be between 5 and 60")
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_SCHEMA_CLASS": "apps.core.openapi_schema.TekDocsAutoSchema",
...
LOGGING = {
    ...
    "formatters": {
        "structured": {
            "()": "tekdocs.safe_logging.SafeJsonFormatter",
        }
    },
