...
| Domains | MSP-owned entered registration records and renewal responsibility | exact-client registration records and renewal responsibility | registrar relationships point to vendor/partner organizations | inventory `0.7.8`; hierarchy/observations `0.7.9`; monitoring `0.7.10`–`0.7.13` |
