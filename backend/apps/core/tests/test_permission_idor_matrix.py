...
def _kwargs_for(route_name: str) -> dict[str, object]:
    ...
    route_kwargs: dict[str, tuple[str, ...]] = {
        ...
        "client-portal-documentation-map-download": ("baseline_id",),
        ...
        "msp-documentation-map-detail": ("map_entity_id",),
        "msp-documentation-map-review": ("map_entity_id",),
        "msp-documentation-map-preview": ("map_entity_id",),
        "msp-documentation-map-baselines": ("map_entity_id",),
        "msp-documentation-map-baseline-download": ("map_entity_id", "baseline_id"),
        ...
        "msp-service-rate-detail": ("rate_id",),
        ...
        "msp-halopsa-ticket-summary-list": (),
        "msp-integration-job-cancel": ("job_id",),
        ...
        "organization-halopsa-ticket-summary-list": ("organization_entity_id",),
        ...
        "organization-integration-observation-list": ("organization_entity_id",),
        ...
        "organization-documentation-map-list-create": ("organization_entity_id",),
        "organization-documentation-map-choices": ("organization_entity_id",),
        "organization-documentation-map-detail": ("organization_entity_id", "map_entity_id"),
        "organization-documentation-map-review": ("organization_entity_id", "map_entity_id"),
        "organization-documentation-map-preview": ("organization_entity_id", "map_entity_id"),
        "organization-documentation-map-baselines": ("organization_entity_id", "map_entity_id"),
