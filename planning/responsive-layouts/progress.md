...
| 4 — Operational records | In progress: People and Sites record workspaces complete | Migrate Organizations to the accepted collection/drawer contract, then run grouped responsive and live-stack acceptance; see [operational-records.md](operational-records.md) |
