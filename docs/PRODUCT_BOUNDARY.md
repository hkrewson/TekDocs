...
| HaloPSA read-only projections | supported | supported | HaloPSA remains authoritative | [#36](https://github.com/hkrewson/TekDocs/issues/36) |
| NinjaOne read-only asset and software observations | supported | supported | NinjaOne remains the RMM system of action; TekDocs records only reviewed mappings | [#37](https://github.com/hkrewson/TekDocs/issues/37) |
