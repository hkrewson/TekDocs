...
3. **Contracts and Networks** — Validate the shared patterns against costs and connected network records. Status: in progress; Contracts and the simplified Networks page migrated; remaining network object surfaces and acceptance open.
