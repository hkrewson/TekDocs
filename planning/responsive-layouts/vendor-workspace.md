...
Products, Licenses, and the grouped real browser-to-Django-to-PostgreSQL acceptance are now complete. Documents follows as Phase 5. Existing user and demo data was preserved; no version, deployment, or Wiki publication change is part of this checkpoint.
