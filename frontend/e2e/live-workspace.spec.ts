...
test('real owner creates and enters a PostgreSQL-backed organization workspace', async ({ browser, page }) => {
  ...
  await page.getByRole('link', { name: 'Assets' }).click()
  await page.getByRole('row').filter({ hasText: 'Live core switch' }).getByRole('link', { name: 'Open record' }).click()
  ...
  await page.getByRole('dialog', { name: 'Live core switch' }).getByRole('link', { name: 'Open record' }).click()
